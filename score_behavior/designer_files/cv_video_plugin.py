...
class CVVideoWidgetPlugin(QPyDesignerCustomWidgetPlugin):
    # Initialise the instance.
    def __init__(self, parent=None):
        super(CVVideoWidgetPlugin, self).__init__(parent)
    ...
    # tool tip.
    def toolTip(self):
        return "Video Viewer for Behavioral Tracking"

    # Return a full description of the custom widget used by Designer in
    # "What's This?" help for the widget.
    def whatsThis(self):
        return "A Video Viewer for OpenCV based behavioral tracking" \
               "using PyQt."
    ...
    def domXml(self):
        return '<widget class="CVVideoWidget" name="cvvideoWidget">\n' \
               ' <property name="toolTip" >\n' \
               '  <string>Video Viewer for Behavioral Tracking</string>\n' \
               ' </property>\n' \
               ' <property name="whatsThis" >\n' \
               '  <string>A Video Viewer for OpenCV based behavioral tracking' \
               'using PyQt.</string>\n' \
               ' </property>\n' \
               '</widget>\n'
    ...
    def includeFile(self):
        return "score_behavior.cv_video_widget"
