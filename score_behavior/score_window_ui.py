...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.trial_status_label = QtWidgets.QLabel(self.groupBox_2)
        self.trial_status_label.setGeometry(QtCore.QRect(20, 40, 121, 20))
        font = QtGui.QFont()
        font.setPointSize(18)
        font.setBold(True)
        font.setWeight(75)
        self.trial_status_label.setFont(font)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.trial_status_label.setText(_translate("MainWindow", "TRIAL STATE"))
