...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.videoInSlides = QtWidgets.QSlider(self.centralwidget)
        self.videoInSlides.setOrientation(QtCore.Qt.Horizontal)
        self.videoInSlides.setObjectName("videoInSlides")
        self.verticalLayout.addWidget(self.videoInSlides)
        self.mirroredButton = QtWidgets.QRadioButton(self.centralwidget)
        self.mirroredButton.setEnabled(False)
        self.mirroredButton.setObjectName("mirroredButton")
        self.verticalLayout.addWidget(self.mirroredButton)
